...
const content: Record<Locale, PublicPagesContent> = {
  bg: {
    ...
    about: {
      ...
      paragraphs: [
        "Наталия Бурачек е масажист в Бургас с 7 години практика, повече от 1000 клиенти и над 5000 проведени масажа. Тя е омъжена и майка на двама прекрасни сина, затова добре разбира колко ценни са спокойствието, доверието и времето за възстановяване.",
        "Работата ѝ съчетава професионални масажни техники, множество сертификати и внимателно отношение към всяко тяло. Преди процедурата Наталия уточнява зоните на напрежение, желаната интензивност и Вашия комфорт, за да получите масаж в Бургас, който е подбран лично за Вас.",
      ],
  ...
  ru: {
    ...
    about: {
      ...
      paragraphs: [
        "Наталья Бурачек — массажист в Бургасе с 7 годами практики, более чем 1000 клиентами и свыше 5000 проведенных массажей. Она замужем и мама двух прекрасных сыновей, поэтому хорошо понимает, насколько важны спокойствие, доверие и время для восстановления.",
        "В работе Наталья сочетает профессиональные массажные техники, множество сертификатов и внимательное отношение к каждому телу. Перед процедурой она уточняет зоны напряжения, желаемую интенсивность и ваш комфорт, чтобы массаж в Бургасе был подобран лично под вас.",
      ],
  ...
  ua: {
    ...
    about: {
      ...
      paragraphs: [
        "Наталія Бурачек — масажист у Бургасі з 7 роками практики, понад 1000 клієнтами та більш ніж 5000 проведених масажів. Вона заміжня і мама двох прекрасних синів, тому добре розуміє, наскільки важливі спокій, довіра та час для відновлення.",
        "У роботі Наталія поєднує професійні масажні техніки, численні сертифікати та уважне ставлення до кожного тіла. Перед процедурою вона уточнює зони напруження, бажану інтенсивність і ваш комфорт, щоб масаж у Бургасі був підібраний особисто для вас.",
      ],
  ...
  en: {
    ...
    about: {
      ...
      paragraphs: [
        "Nataliya Burachek is a massage therapist in Burgas with 7 years of practice, more than 1000 clients and over 5000 completed massage sessions. She is married and a mother of two wonderful sons, so she understands how valuable calm, trust and time for recovery can be.",
        "Her work combines professional massage techniques, many certificates and careful attention to every body. Before the session, Nataliya discusses tension areas, preferred intensity and comfort so your massage in Burgas feels personal, precise and calm.",
      ],
