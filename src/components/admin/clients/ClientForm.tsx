...
export function ClientForm({ clients, initialClient, onClose, onSave, role }: ClientFormProps) {
  ...
  const hasUnsavedChanges = JSON.stringify(form) !== JSON.stringify(buildFormState(initialClient));
          ...
          <div className="admin-client-form-layout">
            ...
            <fieldset className="admin-form-section">
              ...
              <div className="admin-client-form-grid">
                ...
                <label>Email<input autoComplete="email" onChange={(event) => updateForm("email", event.target.value)} type="email" value={form.email} /></label>
